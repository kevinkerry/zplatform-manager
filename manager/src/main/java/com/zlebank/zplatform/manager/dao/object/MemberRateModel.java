...
/**
 * TMemberRate entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "T_MEMBER_RATE", uniqueConstraints = @UniqueConstraint(columnNames = {
		"FEEVER", "BUSICODE", "MEMBERID" }))
public class MemberRateModel implements java.io.Serializable {
     ...
     * serialVersionUID
     */
    private static final long serialVersionUID = 1726329385983300878L;
    private Long tid;
	...
	/** default constructor */
	public MemberRateModel() {
	}

	/** minimal constructor */
	public MemberRateModel(Long tid, String feever, String busicode,
			String memberid, BigDecimal feeRate) {
		this.tid = tid;
		this.feever = feever;
	...
	/** full constructor */
	public MemberRateModel(Long tid, String feever, String busicode,
			String memberid, BigDecimal feeRate, BigDecimal minFee, BigDecimal maxFee,
