 ...
 */
@Repository("txnswith")
public class ITxnsWithdrawDAOImpl
        extends
            AbstractPagedQueryDAOImpl<TxnsWithdrawModel, TxnsWithdrawQuery>
        implements
            ITWithdrawDAO {
    ...
    protected Criteria buildCriteria(TxnsWithdrawQuery e) {
        ...
        if (e != null) {
            ...
            if (StringUtil.isNotEmpty(e.getGatewayorderno())) {
                crite.add(Restrictions.eq("gatewayorderno",
                        e.getGatewayorderno()));
            }
     ...
     */
    @Override
    public TxnsWithdrawModel getTxnsWithdrawByorderNo(String txnseqNo,
            String status,
