...
public class LimitPerdayServiceImpl extends BaseServiceImpl<LimitPerdayModel, Long> implements ILimitPerdayService{
	...
	// 风控版本
	    ...
	    public String AddOneLimitPerday(LimitPerdayModel limitPerday) {	
				...
				Object[] paramaters = new Object[] {limitPerday.getCaseid(),limitPerday.getNums(),limitPerday.getRisklevel(),limitPerday.getNotes(),limitPerday.getRemarks()};
				String[] columns = new String[] {"v_caseid","v_nums","v_risklevel","v_notes","v_remarks"};
