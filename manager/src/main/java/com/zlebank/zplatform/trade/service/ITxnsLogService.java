...
public interface ITxnsLogService extends IBaseService<TxnsLogModel, String>{
    ...
    */
    ...
    /**
     * 根据日期取出t_txns_log中，取出所有发生转账业务的商户
     * 
     * @param date
     * @return
     */
    ...
    public List<?> getCreditRechargeDetailByDate(String memberId, String string);
    ...
    public List<?> getReexchangeMemberByDate(String dateTime1, String dateTime2);
