...
//        super.update(txnsLog);
 ...
 // 消费
    ...
    public List<?>  getAllMemberDetailedByDate(String memberId,String date){
        String queryString = "select t.ACCORDNO,t.TXNSEQNO,t.ACCORDCOMMITIME,t.ACCSETTLEDATE,t.amount,t.busicode,t.TXNFEE, t.TXNSEQNO_OG "
    ...
    public List<?> getBondMemberByDate(String date) {
      //保证金线上充值：20000002,保证金提取：50000002
        String queryString="select distinct t.ACCSECMERNO, t.ACCSETTLEDATE from t_txns_log t where t.ACCSETTLEDATE=? and t.ACCSECMERNO is not null and SUBSTR (trim(t.retcode),-2) = '00' and t.busicode in ('20000002','20000003','50000002')";
        return (List<?>) super.queryBySQL(queryString, new Object[]{date});
    }
    ...
    public List<?> getSumBond(String memberId, String date) {
       String queryString =" select count(*) total,sum (t.amount) totalAmount,sum(t.txnfee) totalfee "
                           +"from t_txns_log t  "
    ...
    public List<?> getBondByDate(String memberId, String date) {       
        String queryString = "select t.ACCORDNO,t.TXNSEQNO,t.ACCORDCOMMITIME,t.ACCSETTLEDATE,t.AMOUNT,t.BUSICODE,t.TXNFEE,t.PAYORDCOMTIME "
    ...
    public List<?> geTransferAccountMemberByDate(String date) {
        String queryString="select distinct t.ACCSECMERNO, t.ACCSETTLEDATE from t_txns_log t where t.ACCSETTLEDATE=? and t.ACCSECMERNO is not null and SUBSTR (trim(t.retcode),-2) = '00' and t.busicode='50000001'";
        return (List<?>) super.queryBySQL(queryString, new Object[]{date});
    }
    ...
    @Override
    public List<?> getTransferAccountByDate(String memberId,
            String date) {
        String queryString = "select t.ACCORDNO,t.TXNSEQNO,t.ACCORDCOMMITIME,t.ACCSETTLEDATE,t.AMOUNT,t.BUSICODE,t.TXNFEE,t.PAYORDCOMTIME "
                + "from t_txns_log t left join t_bnk_txn b on t.payordno=b.payordno where (b.status=9 or b.status is null) and "
    ...
    public List<?> getIndustryRechargeByDate(String dateTime) {
        String queryString="select distinct t.ACCMEMBERID, t.ACCSETTLEDATE from t_txns_log t where t.ACCSETTLEDATE=? and t.ACCMEMBERID is not null and SUBSTR (trim(t.retcode),-2) = '00' and t.busicode='20000005'";
        return super.queryBySQL(queryString, new Object[]{dateTime});
    }
    ...
    public List<?> getSumIndustryRecharge(String memberId, String dateTime) {
        String queryString =" select count(*) total,sum (t.amount) totalAmount,sum(t.txnfee) totalFee "
                ...
                +" and SUBSTR(trim(t.retcode), -2) = '00'";
        return (List<?>) super.queryBySQL(queryString, new Object[]{memberId,dateTime});
    }


    @Override
    public List<?> getIndustryRechargeDetailByDate(String memberId,String dateTime) {
        String queryString = "select t.ACCORDNO,t.TXNSEQNO,t.ACCORDCOMMITIME,t.ACCSETTLEDATE,t.amount,t.busicode,t.TXNFEE,"
    ...
    public List<?> getIndustryConsumeByDate(String dateTime) {
        String queryString="select distinct t.ACCMEMBERID, t.ACCSETTLEDATE from t_txns_log t where t.ACCSETTLEDATE=? and t.ACCMEMBERID is not null and SUBSTR (trim(t.retcode),-2) = '00' and t.busicode='10000005'";
        List<?> result = (List<?>) super.queryBySQL(queryString, new Object[]{dateTime});
        return result;
    }
    ...
    public List<?> getIndustryConsumeDetailByDate(String memberId,String dateTime) {
        String queryString = "select t.ACCORDNO,t.TXNSEQNO,t.ACCORDCOMMITIME,t.ACCSETTLEDATE,t.amount,t.busicode,"
    ...
    public List<?> getIndustryDrawByDate(String dateTime) {
        String queryString="select distinct t.ACCMEMBERID, t.ACCSETTLEDATE from t_txns_log t where t.ACCSETTLEDATE=? and t.ACCMEMBERID is not null and SUBSTR (trim(t.retcode),-2) = '00' and t.busicode='50000004'";
        List<?> result = (List<?>) super.queryBySQL(queryString, new Object[]{dateTime});
        return result;
    }
    ...
    public List<?> getIndustryTransferByDate(String dateTime) {
        String queryString="select distinct t.ACCMEMBERID, t.ACCSETTLEDATE from t_txns_log t where t.ACCSETTLEDATE=? and t.ACCMEMBERID is not null and SUBSTR (trim(t.retcode),-2) = '00' and t.busicode='50000003'";
        List<?> result = (List<?>) super.queryBySQL(queryString, new Object[]{dateTime});
        return result;
    }
    ...
    public List<?> getIndustryRefundByDate(String dateTime) {
        String queryString="select distinct t.ACCMEMBERID, t.ACCSETTLEDATE from t_txns_log t "
    ...
    @Override
    public List<?> getIndustryRefundDetailByDate(String memberId,
            String dateTime) {
        String queryString = "select t.ACCORDNO,t.TXNSEQNO,t.ACCORDCOMMITIME,t.ACCSETTLEDATE,t.amount,t.busicode,"
...
//     String queryString="select distinct t.ACCSECMERNO, t.ACCSETTLEDATE from t_txns_log t 
        //where t.ACCSETTLEDATE=? and t.ACCSECMERNO is not null and SUBSTR (trim(t.retcode),-2) = '00' and t.busicode='70000001'";
        String queryString="select distinct t.TRAN_DATE,tr.MER_ID from t_txns_cmbc_inst_pay_log t,T_INSTEAD_PAY_REALTIME tr "
...
//                + " from t_txns_log t" + " where"
//                + " t.ACCSECMERNO = ?" + " and t.ACCSETTLEDATE = ?"
//                + " and t.busicode ='70000002' "
//                + " and SUBSTR(trim(t.retcode), -2) = '00'";
        String queryString  = " select count(*) total,sum(t.TRANS_AMT) totalAmount from T_TXNS_CMBC_INST_PAY_LOG  t,T_INSTEAD_PAY_REALTIME tr"
...
//        String queryString = "select t.ACCORDNO,t.TXNSEQNO,t.ACCORDCOMMITIME,t.ACCSETTLEDATE,t.amount,t.busicode,t.TXNFEE,t.PAYORDCOMTIME "
//                + "from t_txns_log t left join t_bnk_txn b on t.payordno=b.payordno where (b.status=9 or b.status is null) and t.accsecmerno=? and t.ACCSETTLEDATE=? and t.payordno is not null and SUBSTR (trim(t.retcode), -2) = '00'  and t.busicode ='70000001' ";
        //商户订单号(商户退款订单号)|支付流水号|订单支付时间(yyyyMMddHHmmss)|交易代码|订单金额(单位：分)|失败返回码|失败原因|退汇日期
        String queryString  = " select  tr.ORDERNO,tr.TXNSEQNO,tr.ORDER_COMMI_TIME,tr.TRANS_AMT,t.RESP_CODE ,t.BANK_TRAN_ID ,t.TRAN_DATE,t.RESP_CODE,t.RESP_MSGt,t.return_date "
    ...
    @Override
    public List<?> getReexchangeMemberByDate(String dateTime1, String dateTime2) {//退汇状态为05
        String queryString="select count(*) from t_txns_cmbc_inst_pay_log t,T_INSTEAD_PAY_REALTIME tr "
                + "where tr.TXNSEQNO = t.TXNSEQNO  and tr.STATUS='05' and tr.BANK_TRAN_DATE>? and tr.BANK_TRAN_DATE<? ";
        List<?> result = (List<?>) super.queryBySQL(queryString, new Object[]{dateTime1,dateTime2});
        return result;
    }
    ...
    public List<?> getFtpUploadAddress(String memberId) {
        String queryString = "select IP,PORT,PATH,USER_NAME,PASSWORD from T_MERCH_CONFING t where t.STATUS='00' and t.MEMBER_ID=? ";
        List<?> result = (List<?>) super.queryBySQL(queryString, new Object[]{memberId});
        return result;
    }
    ...
    public List<?> getSinglepaymentMemberByDate(String dateTime) {
        String queryString="select distinct t.ACCSECMERNO, t.ACCSETTLEDATE from t_txns_log t where t.ACCSETTLEDATE=? and t.ACCSECMERNO is not null and SUBSTR (trim(t.retcode),-2) = '00' and t.busicode='70000002'";//单笔代付
        List<?> result = (List<?>) super.queryBySQL(queryString, new Object[]{dateTime});
        return result;
    }
    ...
    @Override
    public List<?> getBatchpaymentDetailedByDate(String memberId,
            String dateTime) {
       String queryString = " select t1.mer_id, t1.order_id,t.TXNSEQNO,t.txn_time, t1.amt,t1.resp_code, t1.resp_msg , t2.payordno, t2.payordfintime,t1.return_date from t_instead_pay_detail t1 " 
