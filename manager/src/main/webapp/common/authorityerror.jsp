...
<body>
	...
	<table width="80%" border="0" align="center" cellpadding="2"
		cellspacing="1" bgcolor="#6785A7">
		<tr>
			<td height="20" align="left" bgcolor="#20A2D3"><strong
				style="color: #FFFFFF">错误</strong></td>
		</tr>
		<tr>
			<td height="50" align="center" valign="middle" bgcolor="#F6F6F6">当前用户没有此功能的操作权限！</td>
		</tr>
		<tr>
			<td height="20" align="center" bgcolor="#CCE2E7"><a
				href="javascript:history.back();"><img
					src="<%=basePath %>pictuer/back.gif" alt="BACK" mouseover="true"
					border="0" /></a></td>
		</tr>
	</table>
</body>
