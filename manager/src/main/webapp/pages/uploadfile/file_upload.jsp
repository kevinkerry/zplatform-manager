...
<script type="text/javascript" src="js/multiplefileupload/multiplefileupload.js"></script>
					...
					<table width="100%" border="1" >
						...
						<tr height="26" id="fileadd1">
							...
							<td colspan="3">
								...
								<input type='button' name='button' id='button' value='浏览...'
									class='type-file-button' />
								<input name="upload" type="file" class="type-file-file"
									id="upload" size="25" />
								<!-- <input type="button" id="addFileSelectButton" class="type-add-button" value="更多文件"/>  -->
							</td>
						</tr>
						<tr height="26" id="fileadd1">
							<td align="center">
						...
						<tr >
							<td align="center" colspan="4" id="uploadbutton">
								<a class="easyui-linkbutton" iconCls="icon-ok" 
									href="javascript:fileUpload()">上传</a>
								<a class="easyui-linkbutton" iconCls="icon-back" 
									href="javascript:back()">返回</a>
							</td>
						</tr>
						<tr >
							<td align="center" colspan="4" id="uploadhint">
								<img alt="正在上传" src="pictuer/loading.gif">文件正在上传,请耐心等待...
							</td>
						</tr>
					</table>
				</form>
	...
	$("#addFileSelectButton").click(function(){fileInputList.add("upload","addFileSelectButton")});
