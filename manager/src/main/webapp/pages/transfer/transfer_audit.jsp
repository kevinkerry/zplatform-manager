	...
	$(function() {
		...
		$('#test').datagrid({
			...
			columns : [ [
					...
					{field : 'tid',title : '划拨批次号',width : 120,align : 'center'},
					{field : 'acctype',title : '账户类型',width : 120,align : 'center',
					...
					{field : 'banktype',title : '支付行号',width : 120,align : 'center'},
					{field : 'bankname',title : '开户行名称',width : 120,align : 'center'},
					{field : 'relatedorderno',title : '关联订单号',width : 120,align : 'center'},
					{field : 'money',title : '划拨金额(元)',width : 120,align : 'center'},
					{field : 'busitype',title : '业务名称',width : 120,align : 'center',
						formatter : function(value, rec) {
										if (value == '7000') {
											return '代付';
										} else if (value == '3000') {
					...
					{field : 'status',title : '操作',width : 120,align : 'center',
						formatter : function(value, rec) {
									if (rec.tranid !=null) {
