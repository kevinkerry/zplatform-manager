...
<jsp:include page="../../top.jsp"></jsp:include>
  ...
  <style type="text/css">
  	...
  	#dedurateInfo {height:25px;}
			#dedurateInfo  tr td{height:25px;border-style:solid;border-width:0px 1px 1px 0px;border-color:#3399FF}
			#dedurateInfo  tr td input{height:15px;margin-left:3px}	
			#dedurateInfo  tr td textarea{height:24px;margin:2px}	
			#dedurateInfo select{margin-left:3px;height:22px}
			.ui-select-input1 a{height:20px;width:40px;margin-right:5px;margin-right:5px;padding:5px}

			#test  tr td{height:45px;}
			#select_zone label{margin:2px;width:140px }
			#other_select_zone label{margin:2px;width:140px }
			
			#deduRateCaseInfo {height:25px;}
			#deduRateCaseInfo tr td{height:25px;border-style:solid;border-width:0px 1px 1px 0px;border-color:#000000;padding:1px}
			#deduRateCaseInfo tr td input{height:20px;margin-left:3px;}
			#deduRateCaseInfo tr td span{height:20px;margin-left:3px;}
			#deduRateCaseInfo tr td select{height:20px;margin-left:3px;}
			#deduRateCaseInfo tr td textarea{height:35px;margin:3px;}	
  </style>
	...
	<div id="w" class="easyui-window" closed="true" title="My Window" iconCls="icon-save" style="width:800px;height:900px;padding:5px;">
		<div class="easyui-layout" fit="true">
				   ...
				   <input type="hidden" id="caseid" name="feecaseModel.caseid">
					<table width="100%" cellpadding="2" cellspacing="2" id="deduRateCaseInfo" border="1">
					    <tr>
							...
							<td align="left">
							   <input id="busiPackCode_show" name="feecaseModel.feever"></input>
							</td>
						...
						<tr style="height: 25px" >
							...
							<td align="left">
							<input id="busicode_show" name="feecaseModel.busicode"></input>
							</td>
							<td align="right" width="174px">名称</td>
							<td align="left"><input type="text" id="businame" name="feecaseModel.businame" class="easyui-validatebox" required="true" maxlength="32"/></td>
						</tr>
						...
						<tr>
							...
							<td align="left"  colspan="4">
								<select name="feecaseModel.setlflg" id="setlflg"
									...
									<option value="3">
										参加清算，有原始交易，原始交易参加清算，本交易清算不退还原始交易费用
									</option>
									<option value="4">
										参加清算，有原始交易，原始交易参加清算，本交易参加清算将退还原始交易手续费
									</option>
									<option value="5">
										参加清算，有原始交易，原始交易参加清算，本交易参加清算将差额退还原始交易手续费
									</option>
								</select>
							</td>
						</tr>
						...
						<td align="right">
							...
							<td align="left" >
								<select id="selfFeeType" class="easyui-validatebox"
									name="feecaseModel.feetype" required="true"></select>
							</td>
							<td align="right">
								手续费返还方式
							</td>
							<td align="left" >
								<select id="feeRetflag" class="easyui-validatebox"
									name="feecaseModel.feeretflag" required="true"></select>
							</td>
						</tr>
						...
						<tr>
							...
							<td align="left" >
								<select id="merchAmtflag" class="easyui-validatebox"
									name="feecaseModel.merchamtflag" >
								<option value="" selected>
										请选择商户对交易额记帐标志
									</option>
									<option value="N">
							...
							<td align="left" >
								<select id="merchFeeflag" class="easyui-validatebox"
									name="feecaseModel.merchfeeflag">
								<option value="" selected>
										请选择商户手续费记帐标志
									</option>
									<option value="N">
						...
						<tr >
							<td>备注</td>
							<td align="left" colspan="3"><textarea id="case_notes" rows="2" cols="115" name="feecaseModel.notes"></textarea>
							</td>
						</tr>							
					</table>
				</form>
			...
			<div region="south" border="false" style="text-align:center;padding:5px 0;">
				<a class="easyui-linkbutton" id="btn_submit" iconCls="icon-ok" onclick="updateFeeCase()">提交</a>
