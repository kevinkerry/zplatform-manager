			...
			<div region="center" border="false" style="padding:10px;background:#fff;border:1px solid #ccc;text-align: center">
				...
				<table width="100%" cellpadding="2" cellspacing="2" style="text-align: left">
					<tr>
						<td width="15%">扣率版本</td>
						<td width="30%">
						<select id="busipack" class="easyui-validatebox"  required="true" name="memberrateModel.feever" onchange="showFeeCase()">
							</select>
						</td>
						<td width="15%" >业务</td>
						<td>
							<select id="busicase" class="easyui-validatebox"  required="true" name="memberrateModel.busicode" >
							<option value="">--请选择业务--</option>
							</select>
						</td>
					</tr>
                    <tr>
						...
						<td width="30%">
						<input id="memberid" name="memberrateModel.memberid"  required="true"  type="text"  class="easyui-validatebox" />
					...
					<tr>
						<td>扣率类型</td>
						<td>
							<select id="feeRateType" class="easyui-validatebox"  required="true" name="memberrateModel.rateType" onchange="showRateDetail()">
						...
						<td>
							<input id="feeRate" name="memberrateModel.feeRateStr" validType="percent"   required="true" type="text" class="easyui-validatebox" maxlength="5"/>
						</td>
					</tr>
					<tr>
						<td>最低收费额(单位:元)</td>
						<td>
							<input id="minFee" name="memberrateModel.minFeeStr" maxlength="12" validType="amount" required="true" type="text"  class="easyui-validatebox"  />
						</td>
						<td width="15%">最高收费额(单位:元)</td>
						<td>
							<input id="maxFee" name="memberrateModel.maxFeeStr"  required="true" maxlength="12" validType="amount" type="text"  class="easyui-validatebox" />
						</td>
					</tr>
					<tr>						
						<td>备注</td>
						<td colspan="3">
							<textarea id="notes" rows="3" cols="75" name="memberrateModel.notes" maxlength="32"></textarea>
						</td>
					</tr>
				</table>
				</form>
