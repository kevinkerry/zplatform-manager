	...
	<div id="w" class="easyui-window" closed="true" title="My Window"
		...
		<div class="easyui-layout" fit="true">
			<div region="center" border="false"
				...
				<form id="txnRateForm"
					action="pages/fee/saveTxnRateFeeAction.action" method="post">
					<table width="100%" cellpadding="2" cellspacing="2"
						...
						<tr>
							...
							<td width="30%"><select id="busipack"
								...
								name="busiRateModel.feever" onchange="showFeeCase()">
							</select></td>
							<td width="15%">业务</td>
							<td><select id="busicase" class="easyui-validatebox"
								required="true" name="busiRateModel.busicode">
									<option value="">--请选择业务--</option>
							</select></td>
						</tr>
						<tr>
							...
							<td><select id="feeRateType" class="easyui-validatebox"
								required="true" name="busiRateModel.rateType"
						...
						<tr>
							...
							<td colspan="3"><textarea id="notes" rows="3" cols="75"
									name="busiRateModel.notes" maxlength="32"></textarea></td>
						</tr>
					</table>
				</form>
			</div>
