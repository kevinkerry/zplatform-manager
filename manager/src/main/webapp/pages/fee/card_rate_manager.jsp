					...
					<table width="100%" cellpadding="2" cellspacing="2"
						...
						<tr>
							...
							<td width="30%"><select id="busipack"
								...
								name="cardrateModel.feever" onchange="showFeeCase()">
							</select></td>
							<td width="15%">业务</td>
							<td><select id="busicase" class="easyui-validatebox"
								required="true" name="cardrateModel.busicode">
									<option value="">--请选择业务--</option>
							</select></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><select id="feeRateType" class="easyui-validatebox"
								required="true" name="cardrateModel.rateType"
							...
							<td><input id="feeRate" name="cardrateModel.feeRateStr"
								validType="percent" type="text" class="easyui-validatebox"
								maxlength="5" /></td>
						</tr>
						<tr>
							<td>最低收费额(单位:元)</td>
							<td><input id="minFee" name="cardrateModel.minFeeStr"
								maxlength="12" validType="amount" type="text"
								class="easyui-validatebox" /></td>
							<td width="15%">最高收费额(单位:元)</td>
							<td><input id="maxFee" name="cardrateModel.maxFeeStr"
								maxlength="12" validType="amount" type="text"
								class="easyui-validatebox" /></td>
						</tr>
						<tr>
							...
							<td colspan="3"><textarea id="notes" rows="3" cols="75"
									name="cardrateModel.notes" maxlength="32"></textarea></td>
						</tr>
					</table>
				</form>
			</div>
