  ...
  <body> 
  	<div style="margin: 5px;border:" id="continer">
	    <div id="p" class="easyui-panel" title="查询条件" style="height:100px;padding:10px;background:#fafafa;"   iconCls="icon-save" collapsible="true">
			<form id="theForm" method="post" action="pages/stat/tradeStatStatAction.action">
				<table width="100%">
					<tr>
						<td align="right" width="10%">起始时间</td>
						<td align="left" style="padding-left:5px" width="15%">
							<input id="beginDate" name="tradeStatRequest.beginDate"/>
						</td>
						<td align="right" width="10%">截止时间</td>
						<td align="left" style="padding-left:5px" width="15%">
							<input id="endDate" name="tradeStatRequest.endDate"/>
						</td>
						</tr>
						<tr>
						<td align="right" width="10%">一级商户会员号</td>
						<td align="left" style="padding-left: 5px" width="15%" >
							<input id="firLevMemId" name="tradeStatRequest.firLevMemId"/>
						</td>
						<td align="right" width="10%">二级商户会员号</td>
						<td align="left" style="padding-left: 5px" width="15%" >
							<input id="secLevMemId" name="tradeStatRequest.secLevMemId"/>
						</td>
						<td align="right">
