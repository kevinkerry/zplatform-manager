				...
				<table width="100%" cellpadding="2" cellspacing="2" style="text-align: left" id="inputForm">
					<tr>
						...
						<td align="left" style="padding-left:5px" width="25%">
							<input name="limitMemDayModel.memberid" id="memberid" validType="merchno" maxlength="15" class="easyui-validatebox" />
						</td>
						<td align="right" width="15%" height="30px">风险等级</td>
						<td align="left" style="padding-left: 5px" width="25%">
							<select id="risklevel" class="easyui-validatebox" missingMessage="请选选择风险等级" required="true" name="limitMemDayModel.risklevel" class="easyui-validatebox">
					...
					<tr>
						...
						<td align="left" style="padding-left:5px" width="25%">
							<input name="limitMemDayModel.limitAmount" id="limitAmount"  validType="amount"   maxlength="11" class="easyui-validatebox" />
						</td>
						<td align="right" width="15%">累计限次</td>
						<td align="left" style="padding-left: 5px" width="25%">
							<input name="limitMemDayModel.limitCount" id="limitCount" maxlength="8" onkeyup="this.value=this.value.replace(/[^\d]/g,'') " />
						</td>
					</tr>
					<tr>
						...
						<td align="left" style="padding-left: 5px" width="25%">
							<input name="limitMemDayModel.notes" id="Notes" maxlength="32"/>
						</td>
					</tr>
				</table>
				</form>
