			...
			<div region="center" border="false" style="padding:10px;background:#fff;border:1px solid #ccc;text-align: center">
				...
				<table width="100%" cellpadding="2" cellspacing="2" style="text-align: left" id="inputForm">
					<tr>
						...
						<td align="left" style="padding-left:5px" width="25%">
							<select id="busicase" class="easyui-validatebox"  required="true" name="limitSingleModel.caseid" >
							<option value="">--请选择业务--</option>
							</select>
						</td>
					</tr>
					<tr>
						...
						<td align="left" style="padding-left:5px" width="25%">
							<input name="limitSingleModel.minAmount" id="minAmount" validType="amount"   maxlength="11" class="easyui-validatebox" />
						</td>
						<td align="right" width="18%" height="30px" >单笔最大限额（元）</td>
						<td align="left" style="padding-left:5px" width="25%">
							<input name="limitSingleModel.maxAmount" id="maxAmount" validType="amount"   maxlength="11" class="easyui-validatebox" />
						</td>
					</tr>
					<tr>
