			...
			<div region="center" border="false" style="padding:10px;background:#fff;border:1px solid #ccc;text-align: center">
				...
				<table width="100%" cellpadding="2" cellspacing="2" style="text-align: left" id="inputForm">
					<tr>
						...
						<td align="left" style="padding-left:5px" width="25%">
							<input name="limitMemCreditDayModel.memberid" id="memberid" validType="merchno" maxlength="15" class="easyui-validatebox" />
						</td>
						<td align="right" width="15%">卡类别</td>
						<td align="left" style="padding-left: 5px" width="25%">
							<select id="cardtype" class="easyui-validatebox"  required="true"  missingMessage="请选择卡类型"  name="limitMemCreditDayModel.cardType" >
							<option value="" selected="selected">--请选择卡类型--</option>
							<option value="1">--借记--</option>
							<option value="2">--贷记--</option>
							<option value="3">--准贷记--</option>
					...
					<tr>
						...
						<td align="left" style="padding-left:5px" width="25%">
							<input name="limitMemCreditDayModel.limitAmount" id="limitAmount"  validType="amount"   maxlength="11" class="easyui-validatebox" />
						</td>
						<td align="right" width="15%">累计限次</td>
						<td align="left" style="padding-left: 5px" width="25%">
							<input name="limitMemCreditDayModel.limitCount" id="limitCount" maxlength="8" onkeyup="this.value=this.value.replace(/[^\d]/g,'') " />
						</td>
					</tr>
					<tr>
					    <td align="right" width="15%" height="30px">风险等级</td>
						<td align="left" style="padding-left: 5px" width="25%">
							<select id="risklevel" class="easyui-validatebox" missingMessage="请选选择风险等级" required="true" name="limitMemCreditDayModel.risklevel" class="easyui-validatebox">
								<option value="">--请选择风险等级--</option>
							</select>
						</td>
						<td align="right" width="15%">备注</td>
						<td align="left" style="padding-left: 5px" width="25%">
							<input name="limitMemCreditDayModel.notes" id="Notes" maxlength="32"/>
						</td>
					</tr>
				</table>
				</form>
