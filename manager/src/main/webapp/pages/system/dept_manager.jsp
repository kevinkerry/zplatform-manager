	...
	<div id="w" class="easyui-window" closed="true" title="My Window" iconCls="icon-save" style="width:500px;height:200px;padding:5px;">
		<div class="easyui-layout" fit="true">
			<div region="center" border="false" style="padding:10px;background:#fff;border:1px solid #ccc;text-align: center">
				...
				<input type="hidden" id="dept_id" name="dept.deptId" />
				<input type="hidden" id="dept_status" name="dept.status" />
				<table width="100%" cellpadding="2" cellspacing="2" style="text-align: left" id="inputForm">
					...
					<tr>
						<td>所属机构</td>
						<td>
							<select id="dept_organId" class="easyui-validatebox" missingMessage="请选择所属机构" required="true" name="dept.organId" class="easyui-validatebox">
					...
					<tr>
						...
						<td>备注</td>
						<td colspan="3">
							<textarea rows="3" cols="60" id="dept_notes" maxlength="64" name="dept.notes"></textarea>
						</td>
					</tr>
				</table>
				</form>
			...
			<div region="center" border="false" style="padding:10px;background:#fff;border:1px solid #ccc;text-align: center">
				...
				<table width="100%" cellpadding="2" cellspacing="2" style="text-align: left" id="inputForm">
					...
					<tr>
						...
						<td>备注</td>
						<td colspan="3">
							<textarea rows="3" cols="60" id="dept_notes" maxlength="64" name="dept.notes" style="resize:none;"></textarea>
						</td>
					</tr>
				</table>
				</form>
