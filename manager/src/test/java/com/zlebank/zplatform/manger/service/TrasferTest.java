...
public class TrasferTest {
    ...
    public void auditTranBatch() {
        ...
        try {
            ...
            for (PojoTranData tranData : tranDatas) {
                ...
                boolean isSuccess = transferServiceImpl.transferDataTrial(
                        tranData.getTid(), isApproved);
                if (!isSuccess) {
    ...
    public void testQueryTranData() {
        List<BankTranBatch> list = transferServiceImpl
                .queryBankTranBatchByTranBatch(tranBatchId,
